...
def parse_arguments():
    ...
    meta_group.add_argument("--use-pdf-metadata", action="store_true",
                            help="Use PDF embedded metadata only")
    meta_group.add_argument("--use-crossref", action="store_true",
                            help="Use Crossref API (default)")
    meta_group.add_argument("--use-layoutlmv3", action="store_true",
